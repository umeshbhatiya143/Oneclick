      ...
      <div className="company_data_hld">
        ...
        <div className="heading_dropdown_hld">
          ...
          <div className="dropdowns">
            <select name="" id="" onChange={(e) => setjobCategory(e.target.value)}>
        ...
        {/* data_actiona_row */}
        <ul className="data_action_row">
          <li className='jobCategory'>{jobCategory}</li>
          <li style={{ color: "var(--primary_color)" }}>Total:6</li>
          <li style={{ color: "var(--success_color)" }}>Approved:2</li>
          <li style={{ color: "var(--danger_color)" }}>Rejected:4</li>
        </ul>
